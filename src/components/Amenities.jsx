...
const Amenities = () => (
  <section id="whychooseus" className="py-16 px-6 max-w-6xl mx-auto">
    <p className="text-[#556B2F] text-center font-bold mb-10">Why Choose Greens and Acres</p>
