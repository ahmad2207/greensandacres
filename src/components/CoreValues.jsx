...
const CoreValues = () => (
  <section id="corevalues" className="py-16 px-6 text-center">
    <p className="text-m font-bold mb-6 text-[#228B22]">Our Core Values</p>
    <h2 className="text-3xl mb-10 font-bold">The principles that guide everything we do</h2>
    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
      <div className="p-6 bg-white rounded-2xl shadow">
        <FaLightbulb className="text-[#228B22] text-4xl mx-auto mb-4" />
      ...
      <div className="p-6 bg-white rounded-2xl shadow">
        <FaBalanceScale className="text-[#228B22] text-4xl mx-auto mb-4" />
      ...
      <div className="p-6 bg-white rounded-2xl shadow">
        <FaLeaf className="text-[#228B22] text-4xl mx-auto mb-4" />
